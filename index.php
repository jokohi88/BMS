                            ...
                            <table class="table table-hover table-bordered" id="mytable" style="margin-top: 10px">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <a href="tambah.php" class="btn btn-success btn-md"><span class="fa fa-plus"></span></a>
                                            <a href="edit-user.php?id=<?php echo $isi['id_login'];?>" class="btn btn-success btn-md">
                                            <span class="fa fa-edit"></span></a>
                                            <a onclick="return confirm('Apakah yakin data akan di hapus?')" href="proses/crud.php?aksi=hapus-user&hapusid=<?php echo $isi['id_login'];?>" 
